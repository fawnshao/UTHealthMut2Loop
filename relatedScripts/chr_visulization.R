...
pdf(file = "HKG.v1.5.byGTEx.pdf", width = 15, height = 12)
...
pdf(file = "TSG.v1.5.byGTEx.pdf", width = 15, height = 12)
kp <- plotKaryotype(genome="hg19", plot.type = 2)
kpDataBackground(kp, r0 = 0, r1 = 0.8, data.panel = 1)
kpDataBackground(kp, r0 = 0, r1 = 0.5, data.panel = 2)
input <- tsg.input
...
pdf(file = "HKG.TSG.v1.5.byGTEx.vsALL.pdf", width = 15, height = 12)
kp <- plotKaryotype(genome="hg19", plot.type = 2)
kpDataBackground(kp, r0 = 0, r1 = 0.8, data.panel = 1)
kpDataBackground(kp, r0 = 0, r1 = 0.5, data.panel = 2)
