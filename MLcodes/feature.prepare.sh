...
#########################
head -1 total.type.srt.class > onlyhkg.tsg.further.srt.class
awk '$2~/hkg/' onlyhkg.tsg.further.class | sort -k2 | grep -v "hkg10" >> onlyhkg.tsg.further.srt.class
awk '$2~/hkg/' onlyhkg.tsg.further.class | sort -k2 | grep "hkg10" >> onlyhkg.tsg.further.srt.class
awk '$2!~/hkg/ && $2!~/mixTSG/' onlyhkg.tsg.further.class | tail -n +2 >> onlyhkg.tsg.further.srt.class
awk '$2~/mixTSG/' onlyhkg.tsg.further.class >> onlyhkg.tsg.further.srt.class
perl ~/myScripts/add_any_2files_together.pl total.type.srt.all onlyhkg.tsg.further.srt.class 0 0 | cut -f 1-2,5- > onlyhkg.tsg.further.srt.all
